...
class RNBServer(Example.MyInterface):
    def __init__(self):
        self.musiques = []
    ...
    def addMusique(self, genre, nom, auteur, current=None):
        with open("RNB/"+auteur+"-"+nom+".mp3", "rb") as file:
...
with Ice.initialize(sys.argv) as communicator:
    ...
    adapter = communicator.createObjectAdapterWithEndpoints("RNBServer", "default -p 10000")
    object = RapServer()
